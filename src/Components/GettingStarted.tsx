...
const GettingStarted = () => {
  return (
    <div className="px-4 min-h-full mt-16  text-blue-950 flex justify-center items-center">
      <div className=" text-center">
        <h1 className="text-xl sm:text-3xl font-mono font-bold text-blue-950 mb-6">Getting Started with Internet Computer</h1>
